		...
		<tbody class="tools">
			...
			<tr>
				...
				<td>
					...
					<p>
						<span class="description"><?php _e( 'This tool will remove all WooCommerce, Product, Customers and Order data when using the "Delete" link on the plugins screen. It will also remove any setting/option prepended with "woocommerce_" so may also affect installed WooCommerce Extensions.', 'woocommerce' ); ?></span>
					</p>
				</td>
			</tr>
		</tbody>
